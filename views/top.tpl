...
<p></p>
	...
	<div class="tab-content">
	  ...
	  <ul>
	    ...
	    <li>複数の検索語を使う場合にはスペースを区切り文字としてください。</li>
	    <li>検索語の先頭に ! をつけると、その検索語を含まない検索をします。</li>
	    <li>英語は Case Insensitevieですので、小文字、大文字でも同じ結果となります。</li>
	    <li>例：英語の検索語をgradeおよびaddとし、日本語では成績を含み、方略は含まない検索の場合、下記のように入力します。<br>
	    Search Term:　 grade　add、 検索語：　成績　!方略</li>
	    <li>検索対象のPOはSakaiが初期値ですが、Moodle、MaharaのPOも対象とする場合にはチェックボックスをクリックしてください。</li>
	    <li>検索結果表示画面からこの画面に戻るには、右上に表示される[TOPページ]ボタンをクリックしてください。</li>
	  </ul>
	  </div>
	  <div class="tab-pane" id="2">
	  <br>
	    <ul>
	    <li>大学教育で利用されるシステムの翻訳結果を横断的にまとめた事例ベースの文章単位の用例集です。</li>
